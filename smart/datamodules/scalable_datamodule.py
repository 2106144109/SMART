...
class MultiDataModule(pl.LightningDataModule):
    transforms = {
        ...
        "MaritimeTargetBuilder": MaritimeTargetBuilder,
    }
    ...
    def __init__(self,
        ...
        TransformClass = MultiDataModule.transforms[transform]
        if transform == "MaritimeTargetBuilder":
            train_transform = TransformClass(num_historical_steps, num_future_steps, "train", token_size=self.token_size)
            val_transform = TransformClass(num_historical_steps, num_future_steps, "val", token_size=self.token_size)
            test_transform = TransformClass(num_historical_steps, num_future_steps, token_size=self.token_size)
        else:
            train_transform = TransformClass(num_historical_steps, num_future_steps, "train")
            val_transform = TransformClass(num_historical_steps, num_future_steps, "val")
            test_transform = TransformClass(num_historical_steps, num_future_steps)
